        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="flex gap-4 mb-6">
            ...
            >
              ...
              <p className="text-[10px] text-gray-400 leading-tight">List and sell electronic devices</p>
            </button>
            <button 
              type="button"
            ...
            >
              <p className="text-sm font-bold text-gray-700">Repair Shop / Tech-Harvester</p>
              <p className="text-[10px] text-gray-400 leading-tight">Browse and bid on components</p>
            </button>
          </div>
...
>
  {loading ? 'Signing In...' : 'Sign In'} <span>→</span>
          ...
          <div className="relative flex py-5 items-center">
            ...
            <span className="flex-shrink mx-4 text-gray-300 text-[10px] uppercase">Or continue with</span>
            <div className="flex-grow border-t border-gray-200"></div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button 
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2 border border-gray-200 rounded-lg text-sm hover:bg-gray-50"
            >
              <img src="https://www.svgrepo.com/show/303114/facebook-3.svg" className="w-4 h-4" alt="Facebook" /> Facebook
            </button>
          </div>

          <p className="text-center text-xs text-gray-400 mt-6">
            Don't have an account? <span onClick={onSignUpClick} className="text-teal-600 font-bold cursor-pointer hover:underline">Create Account</span>
          </p>
        </div>
      </div>
    </div>
